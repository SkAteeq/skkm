...
export default function App() {
  return (
    <div className="relative bg-[var(--color-dark-bg)] overflow-x-hidden">
      <Navigation />
      ...
      <section id="home" className="relative h-screen flex flex-col items-center justify-center text-center px-6">
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          >
            ...
            <h1 className="text-5xl md:text-8xl font-black leading-tight tracking-tighter">
              <motion.span
                ...
                className="block"
              >
                AI <span className="text-white/20">•</span> DATA <span className="text-white/20">•</span> SYSTEMS
              </motion.span>
            </h1>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-white/50 max-w-2xl mx-auto mb-2 font-light leading-relaxed"
          >
          ...
          >
            <a href="#projects" className="px-8 py-4 bg-white text-black rounded-2xl font-bold hover:bg-brand-primary transition-colors">
              Explore Projects
            </a>
            <a href="#contact" className="px-8 py-4 glass-morphism rounded-2xl font-bold hover:bg-white/10 transition-colors">
              Contact Me
            </a>
          </motion.div>
        </div>
        ...
        <motion.div
          animate={{ y: [0, 10, 0] }}
          transition={{ duration: 2, repeat: Infinity }}
          className="absolute bottom-10 left-1/2 -translate-x-1/2 w-6 h-10 rounded-full border-2 border-white/20 flex justify-center pt-2"
        >
      ...
      {/* Footer */}
      <footer className="py-12 border-t border-white/5 text-center text-white/30 text-xs">
